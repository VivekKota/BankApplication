...
public class CurrentAccountService {
	...
	public void currentAccount(long customerId) {
		...
		while (!service) {
			...
			case 1:
				...
				currentAccount.deposit(account, amount);
			...
			case 2:
				...
				currentAccount.withdraw(account, amount);
			...
			case 3:
				...
				if (accountTransferNo == reaccountTransferNo) {
					...
					if (receiverAccount != null) {
						...
						currentAccount.transfer(account, receiverAccount, amount);
			...
			case 6:
				...
				System.out.println();
				System.out.println("Avialable Balance : " + account.getBalance());
